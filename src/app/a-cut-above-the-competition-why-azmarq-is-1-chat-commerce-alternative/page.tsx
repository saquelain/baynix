...
export default function CutAbovePage() {
  return (
    <>
      <Navbar />
      <main style={{ background: 'var(--bg)', minHeight: '100vh', paddingTop: 64, color: 'var(--text)' }}>
        ...
        <section style={{ padding: '5rem 2rem 4rem', position: 'relative', overflow: 'hidden', borderBottom: '1px solid var(--border)' }}>
          <div style={{ position: 'absolute', width: 600, height: 500, background: 'radial-gradient(ellipse, rgba(16,185,129,0.09) 0%, transparent 70%)', top: '0%', left: '10%', pointerEvents: 'none' }} />
          <div style={{ position: 'absolute', width: 400, height: 300, background: 'radial-gradient(ellipse, rgba(34,211,238,0.07) 0%, transparent 70%)', top: '10%', right: '5%', pointerEvents: 'none' }} />
          ...
          <div style={{ maxWidth: 760, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            ...
            <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1.15, marginBottom: '1.5rem' }}>
              A Cut Above the Competition: Why Baynix is #1 Chat Commerce Alternative
            </h1>

            <p style={{ fontSize: '1.05rem', color: 'var(--text2)', lineHeight: 1.75, marginBottom: '2rem' }}>
              In today&apos;s digital-first economy, businesses don&apos;t just compete on product or price — they compete on experience. Discover why Baynix leads the pack as the top chat commerce platform for modern brands.
            </p>

            {/* Icon banner */}
            <div style={{ height: 220, background: 'linear-gradient(135deg, rgba(16,185,129,0.12) 0%, rgba(34,211,238,0.1) 100%)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Trophy size={72} color="#10b981" strokeWidth={1.1} style={{ opacity: 0.7 }} />
            </div>
          </div>
        </section>
          ...
          <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
            <div style={{ background: 'var(--glass-bg)', backdropFilter: 'var(--glass-blur)', WebkitBackdropFilter: 'var(--glass-blur)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: '3rem 2rem' }}>
              <p style={{ fontSize: '0.95rem', color: 'var(--text2)', lineHeight: 1.7, marginBottom: '1.5rem' }}>
                Full article coming soon. We&apos;re preparing a deep-dive comparison of Baynix against the competition.
              </p>
